...
Module.register("MMM-HomeWizard", {
	defaults: {
	...
	getDom: function() {
		...
		// Last updated notification disabled for now
		if (this.dataNotification) {
			var wrapperDataNotification = document.createElement("div");
			// translations  + datanotification
			//wrapperDataNotification.innerHTML =  this.translate("UPDATE") + ": " + this.dataNotification.date;
			wrapperDataNotification.className = "xsmall";
	...
	processData: function(data) {
		...
		this.sendSocketNotification("MMM-HomeWizard-NOTIFICATION_TEST", data);
	},

	// socketNotificationReceived from helper
	socketNotificationReceived: function (notification, payload) {
		if(notification === "MMM-HomeWizard-NOTIFICATION_TEST") {
